...
<p style="font-weight: bold; text-align: right;"><?=translate('View stats for lab')?></p>
</td>
<td align="left">
<select name="choose_lab" class="textbox" onchange="javascript: changeLab(this);">
<?
for ($i = 0; $i < count($links); $i++)
	echo '<option value="' . $links[$i]['lab_id'] . '"' . ($links[$i]['lab_id'] == $currentid ? ' selected="selected"' : '') . '>' . $links[$i]['labTitle'] . "</option>\n";
?>
</select>
</td></tr>
</table>
