                ...
                <tr>
                    <td width="330">
						...
						<?php
							...
							if ($user->getIsAdmin() && $res->type == RES_TYPE_ADD) {
...
function printAccountInfo($res, $user) {
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="1">
        <tr class="tableBorder">
			...
			-->
				<?php
					$account_data = $res->getReservationAccountData();
					if($account_data){
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="1">
            <tr class="tableBorder">
                <td>
                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr>
                            <td class="cellColor" colspan="2"><h5 align="center">Recurring Reservation</h5></td>
                        </tr>
                        <tr>
                            <td class="cellColor formNames" style="text-align: left;" nowrap="nowrap">
                                <p><?php echo translate('Repeat every')?></p>
                            </td>
                            <td class="formNames"><p><?php echo translate('Repeat until')?></p></td>
                        </tr>
                        <tr>
                            <td class="cellColor">
                            ...
                            <td class="cellColor">
                                <div id="days" style="position: relative; visibility: hidden; overflow: auto; display: none;">
