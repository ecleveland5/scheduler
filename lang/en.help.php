...
* @package Languages
*
* Copyright (C) 2003 - 2005 the NanoCenter Scheduler
* License: GPL, see LICENSE
*/
///////////////////////////////////////////////////////////
// INSTRUCTIONS
///////////////////////////////////////////////////////////
// This file contains all the help file for phpLabit.  Please save the translated
//  file as '2 letter language code'.help.php.  For example, en.help.php.
// 
// To make the NanoCenter Scheduler help available in another language, simply translate this
...
?>
<div align="center"> 
  <h3><a name="top" id="top"></a>Introduction to NanoCenter Equipment Scheduler</h3>
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: solid #CCCCCC 1px">
    <tr> 
      <td bgcolor="#FAFAFA"> 
        ...
        <p>In order to use  the NanoCenter Scheduler, you must first register. 
          ...
          Clicking the &quot;Help Me&quot; link brings this pop-up help window. Clicking
          ...
          <p><font color="#FF0000">Warning:</font> If you have Norton Personal
            Firewall running while using the NanoCenter Scheduler, you may encounter problems.
            Please disable Norton Personal Firewall while using the NanoCenter Scheduler
...
<!-- 
        ...
        <p>On the login page, there will be a pull down menu with all of the
          ...
          Please select the language that you prefer and all the NanoCenter Scheduler text
...
-->
        ...
        <p>To change your profile information (name, email, etc.) or your password, 
          ...
          Panel</a>, in <a href="#quick_links">My Quick Links</a>, click &quot;Edit My Info&quot;. 
		  This will bring you to a form with your information filled in. Edit any information you wish. Any 
        ...
        <p>The Quick Links table will provide you with common application links.
          The first, &quot;Go to the Online Scheduler&quot; will take you to
          the default lab. Here you can view resource labs, reserve
        ...
        <p>&quot;Resource  Calendar&quot; will bring you to a
          calendar view of the reservations for a selected resource or all resources
          of a selected lab. If you have selected the day view of a specific
        ...
        <p>&quot;My Email Preferences&quot; will take you to a page where
        ...
        <p align="right"><a href="#top">Top</a></p>
        <h5><a name="my_training" id="my_training"></a>My Equipment Access</h5>
        <p>The My Equipment Access table shows all the equipment that you have been given permission to use.
        ...
        <p>Upon registration, you will be given not have permission to use any resources unless the administrator
          ...
          which you have not been given permission, but you will be able to view its lab 
...
-->
        ...
        <p>The scheduler is where you can perform all resource scheduling functions.
          ...
          (default) 
          days. Here you can view resource labs, reserve resources, and
          ...
          to
        view them.</p>
        <p>You can change labs (if more than one exist) using the pull down
          menu at the top of each lab.</p>
        ...
        <p>If you have not yet registered or logged in, you can view a read-only
          version of the lab schedule by clicking on the &quot;View Lab Schedule&quot; link
          on the login page. This version of the lab will show you all resources
        ...
        <p>After setting correct beginning and ending days/times for the
          ...
          reservation. After your reservation has been successfully made, the
            lab will automatically refresh. This is required to reload all
        ...
        <p>To edit a reservation through the scheduler, simply click on the
          ...
          other reservations. After your reservation has been successfully modified,
           the lab will automatically refresh. This is required to reload
