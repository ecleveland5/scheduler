...
// INSTRUCTIONS
///////////////////////////////////////////////////////////
// This file contains all of the strings that are used throughout phpLabit.
...
$dates['lab_daily'] = '%A,<br/>%m/%d/%Y';
// Date on top-right of each page
$dates['header'] = '%A, %B %d, %Y';
// Jump box format on bottom of the lab page
...
$strings['Help'] = 'Ajuda';
$strings['Manage Labs'] = 'Gerir Agenda';
...
$strings['That lab is not available.'] = 'Esta agenda não está disponível';
$strings['You did not select any labs to delete.'] = 'Você não selecionou nenhum compromisso para excluir.';
...
$strings['Lab title is required.'] = 'O título do compromisso é obrigatório.';
...
$strings['Valid lab must be selected'] = 'Um compromisso válido deve ser selecionado';
...
$strings['Lab Title'] = 'Título do Compromisso';
...
$strings['Add Lab'] = 'Adicionar Compromisso';
$strings['Edit Lab'] = 'Editar Compromisso';
$strings['No'] = 'Não';
$strings['Yes'] = 'Sim';
$strings['Name'] = 'Nome';
...
$strings['Sort by descending lab title'] = 'Ordenar título do compromisso decrescente';
...
$strings['Sort by ascending lab title'] = 'Ordenar título do compromisso crescente';
...
$strings['Lab'] = 'Marcação';
$strings['Phone'] = 'Telefone';
$strings['Notes'] = 'Notas';
$strings['Status'] = 'Status';
$strings['All Labs'] = 'Todas as marcações';
...
$strings['View Lab'] = 'Ver marcações';
$strings['View a read-only version of the lab'] = 'Ver versão de leitura das marcações';
...
$strings['Go to the Online Scheduler'] = 'Ir para gestor de reservas';
...
$strings['Search Labd Resource Usage'] = 'Search Labd Resource Usage';
...
$strings['View stats for lab'] = 'Ver estado das reservas:';
...
$strings['This will set up all the necessary databases and tables for phpScheduleIt.'] = 'Isto permitirá criar a Base de Dados e tabelas necessárias ao PhpLabIt.';
...
$strings['There were errors during the install.'] = 'Houve erros durante a instalação. É no entanto possivel que o PhpLabIt funcione, se os erros nao foram graves.<br/><br/>'
	. 'Por favor coloque perguntas no forum em <a href="http://sourceforge.net/forum/?group_id=95547">SourceForge</a>.';
$strings['You have successfully finished setting up phpScheduleIt and are ready to begin using it.'] = 'O PhpLabIt foi instalado com sucesso e está pronto a ser utilizado.';
