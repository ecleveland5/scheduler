...
$strings['Manage Labs'] = 'Διαχείριση Προγραμμάτων';
...
$strings['That lab is not available.'] = 'Το πρόγραμμα αυτό δεν είναι διαθέσιμο.';
$strings['You did not select any labs to delete.'] = 'Δεν επιλέξατε πρόγραμμα προς διαγραφή.';
...
$strings['Lab title is required.'] = 'Το Πρόγραμμα πρέπει να έχει τίτλο.';
...
$strings['Valid lab must be selected'] = 'Επιλέξτε κάποιο έγκυρο πρόγραμμα';
...
$strings['Lab Title'] = 'Τίτλος Προγράμματος';
...
$strings['Add Lab'] = 'Πρόσθεση Προγράμματος';
$strings['Edit Lab'] = 'Επεξεργασία Προγράμματος';
$strings['No'] = 'Όχι';
$strings['Yes'] = 'Ναι';
...
$strings['Sort by descending lab title'] = 'Φιλτράρισμα ανά τίτλο προγράμματος με φθίνουσα σειρά';
...
$strings['Sort by ascending lab title'] = 'Φιλτράρισμα ανά τίτλο προγράμματος με αύξουσα σειρά';
...
$strings['Lab'] = 'Πρόγραμμα';
$strings['Phone'] = 'Τηλέφωνο';
$strings['Notes'] = 'Σημείωση';
$strings['Status'] = 'Κατάσταση';
$strings['All Labs'] = 'Ολα τα Προγράμματα';
...
$strings['View Lab'] = 'Προβολή Προγράμματος';
$strings['View a read-only version of the lab'] = 'Εμφάνιση μιας αποκλειστικά αναγνώσιμης έκδοσης του προγράμματος';
...
$strings['Go to the Online Scheduler'] = 'Ραντεβού';
...
$strings['Search Labd Resource Usage'] = 'Αναζήτηση Χρήσης Πόρου';
...
$strings['View lab'] = 'Εμφάνιση προγράμματος:';
$strings['My Reservations'] = 'Κατάλογος Κρατήσεων';
...
$strings['View stats for lab'] = 'Εμφάνιση στατιστικών για πρόγραμμα:';
