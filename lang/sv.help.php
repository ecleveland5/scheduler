...
<div align="center"> 
  ...
  <p><a href="http://phplabit.sourceforge.net" target="_blank">http://phplabit.sourceforge.net</a></p>
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: solid #CCCCCC 1px">
    <tr> 
      <td bgcolor="#FAFAFA"> 
        <ul>
          <li><b><a href="#getting_started">Komma igång</a></b>
		  <ul>
          ...
          <li><a href="#my_control_panel"><b>Startsidan</b></a>
          <ul>
          ...
          <li><a href="#using_the_scheduler"><b>Använd bokningssystemet</b></a>
          <ul>
