...
$strings['Help'] = 'Помощь';
$strings['Manage Labs'] = 'Управление расписаниями';
...
$strings['That lab is not available.'] = 'Это расписание недоступно.';
$strings['You did not select any labs to delete.'] = 'Вы не выбрали расписаний для удаления.';
...
$strings['Lab title is required.'] = 'Заголовок расписания обязателен.';
...
$strings['Valid lab must be selected'] = 'Правильное расписание должно быть выбрано';
...
$strings['Lab Title'] = 'Заголовок расписания';
...
$strings['Add Lab'] = 'Добавить расписание';
$strings['Edit Lab'] = 'Править расписание';
$strings['No'] = 'Нет';
$strings['Yes'] = 'Да';
...
$strings['Sort by descending lab title'] = 'Сортировать по убыванию заголовков расписаний';
...
$strings['Sort by ascending lab title'] = 'Сортироват по возрастанию заголовков расписаний';
...
$strings['Lab'] = 'Расписание';
$strings['Phone'] = 'Телефон';
$strings['Notes'] = 'Заметки';
$strings['Status'] = 'Статус';
$strings['All Labs'] = 'Все расписания';
...
$strings['View Lab'] = 'Смотреть расписание';
$strings['View a read-only version of the lab'] = 'Смотреть версию данного расписания только-для-чтения';
...
$strings['Go to the Online Scheduler'] = 'Перейти к расписанию он-лайн';
...
$strings['Search Labd Resource Usage'] = 'Поиск использования ресурса расписания';
...
$strings['View stats for lab'] = 'Смотреть статистику для расписания:';
